...
`
    const messageText = `
🐱 <b>FoilOps | Wallet Tracker & Scam Intelligence</b>
...
🐱 FoilOps | Wallet Tracker

Get real time activity notifications for any wallet you add!

You must have a FoilOps <b>PRO</b> or <b>WHALE</b> subscription to use this bot in a group
...
You can try by adding some <b>SOL</b> to your FoilOps personal wallet 😺
`
...
Maybe try adding some <b>SOL</b> to your FoilOps personal wallet 😺
`
...
`,
    ...
    const messageText = `
You can now use <b>FoilOps</b> in any group chat!

Your groups: (${userGroups.length} / ${MAX_USER_GROUPS})
${groupsContent}
Learn how to add <b>FoilOps</b> to a group chat: /help_group
`
    return messageText
  }

  static groupChatNotStarted = `
🚫 You cannot change FoilOps settings in this group
