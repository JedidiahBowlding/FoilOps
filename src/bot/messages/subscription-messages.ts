...
1. Transfer the required <b>SOL</b> to your <b>FoilOps</b> wallet: <code>${user?.personalWalletPubKey}</code>
...
🚫 You can only add FoilOps to a group if you have a <b>PRO</b> or a <b>WHALE</b> subscription.
...
To add <b>FoilOps</b> to Groups, you need a <b>PRO</b> or <b>WHALE</b> subscription
...
To ensure a successful renewal, please make sure your <b>FoilOps wallet</b> has the necessary funds.
