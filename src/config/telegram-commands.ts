...
export const TELEGRAM_COMMANDS: TelegramBot.BotCommand[] = [
  ...
  { command: 'monitoring', description: 'View Base watches and auto-buy orders' },
  { command: 'base_watches', description: 'View persistent Base launch watches' },
  { command: 'autobuy_orders', description: 'View liquidity auto-buy order status' },
